...
import { ChannelTable, ActionEmoji } from "../../models/holdem";
    ...
    while (table.currentRound) {
      ...
      try {
        ...
        await new Promise((resolve, reject) => Yargs()
          ...
          .command(
            ...
            async ({ amount }) => {
              ...
              await table.playRandomSound("./sounds/holdem/bet-raise");
            }
          )
          .command(
            "call",
            ...
            async () => {
              ...
              await table.playRandomSound("./sounds/holdem/call");
            }
          )
          .command(
            "check",
            ...
            async () => {
              ...
              await table.playRandomSound("./sounds/holdem/check");
            }
          )
          .command(
            "raise <amount>",
          ...
          .command(
            ...
            async () => {
              ...
              await table.playRandomSound("./sounds/holdem/fold");
            }
          )
        ...
        if (table.voiceConnection && roundAfterAction !== roundBeforeAction) {
          ...
          (async () => {
            await table.playRandomSound("./sounds/holdem/gather-chips");
            await new Promise((resolve) => setTimeout(resolve, 500));
            switch (roundAfterAction) {
              case BettingRound.FLOP:
                for (let index = 0; index < 3; index++) {
                  await table.playRandomSound("./sounds/holdem/place-card");
                }
                break;
              ...
              case BettingRound.RIVER:
                ...
                break;
              default:
                await table.playRandomSound("./sounds/holdem/winner");
                break;
            }
          })();
        }
